...
export function CouponsTable({ columns, data }) {
    const { deleteMultipleCoupons } = useCoupons()
                    ...
                    <Button
                        onClick={async () => {
                            ...
                            if (selectedRowIds.length > 0) {
                                if (window.confirm('Are you sure you want to delete the selected coupon?')) {
                                    try {
                                        await deleteMultipleCoupons(selectedRowIds)
                                ...
                                toast.info('No coupons selected for deletion');
                            }
                        }}
                        variant='destructive'
                    >
