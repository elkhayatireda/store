...
import { ImageUp, X, ChevronLeft, Trash, Eye, Check } from "lucide-react";
...
export default function AddCoupon() {
  ...
  const fetchCouponsData = async (id) => {
    try {
      const couponResponse = await axiosClient.get(`/coupons/${id}`);
      const couponData = couponResponse.data;
        console.log("coupon  ",couponData)
      setFormData({
        date: couponData.expirationDate,
        allProduct: couponData.appliesToAllProducts,
        selectedProducts: couponData.productIds,
        selectedDiscountType: couponData.discountType,
  ...
  return (
    <div className="flex flex-col pt-5   pr-5 px-10 relative pb-36">
      ...
      <div className="w-full flex items-center justify-between mb-10">
        <h4 className="text-4xl font-semibold text-[#141414]">Update Coupon</h4>
        <Link
      ...
      <div className="border-2 border-gray-200 rounded p-4 ">
        <div className="flex flex-col gap-5  w-full ">
          <div className="flex  items-center justify-between gap-6">
            ...
            <div className="w-full basis-1/3">
              <Select
                ...
                value={formData.selectedDiscountType}
              >
          ...
          <div className="w-full flex  items-center justify-start gap-6">
            ...
            <div className="w-full basis-1/3">
              <DatePickerDemo onDateChange={handleDateChange} selected={formData.date}/>
            </div>
            <div className="basis-1/3">
              <input
                type="Number"
